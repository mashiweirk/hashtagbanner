...
function uploadPhotoToFacebook() {
    //var globCanvas[0] = document.getElementById('globCanvas[0]');
	//ctx = globCanvas[0].getContext('2d'),
	//globMirror[0] = document.getElementById('globMirror[0]');
    var mimeType = 'image/png';
    var imageData = globCanvas.toDataURL(mimeType);
...
function getProfileImage() {
            ...
            FB.api('/me', function(response){
                ...
                globObj.img = loadImage('http://graph.facebook.com/' + myFBCanvasID + '/picture?width=' + globCanvas.width + '&height=' + globCanvas.height, updateInfo);
                $btn.addClass('hide');
